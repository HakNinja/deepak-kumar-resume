...
<div className="vertical-line-left"></div>
        ...
        <a href="/"  ><p className="website-head-link-para">deepak</p> <span>kumar</span></a>
        ...
        <ul className="followup-Links-UL-Navbar">
                    <li><a href="https://www.facebook.com/profile.php?id=100069794556607" target='_blank' rel="noreferrer" className="follow-Hyperlink-Navbar"><i className="fab fa-facebook-square"/></a></li>
                    <li><a href="https://api.whatsapp.com/qr/XZMXDXJDMSVLL1" target='_blank' rel="noreferrer" className="follow-Hyperlink1-Navbar"><i className="fab fa-whatsapp-square"/></a></li>
                    <li><a href="https://www.instagram.com/deepak_kumar_arya__/ " target='_blank' rel="noreferrer" className="follow-Hyperlink2-Navbar"><i className="fab fa-instagram-square"/></a></li>
                    </ul>
        </div>
        </div>
